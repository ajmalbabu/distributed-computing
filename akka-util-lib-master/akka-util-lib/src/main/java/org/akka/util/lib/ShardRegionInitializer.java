...
import org.akka.util.lib.model.DefaultMessageExtractor;
 ...
 * Initializes based on the configuration provided in the akka.util.lib.clusterShards section of yaml file.
 */
@Component
public class ShardRegionInitializer {
     ...
     */
    @Value("${akka.util.lib.number.of.shards:10}")
