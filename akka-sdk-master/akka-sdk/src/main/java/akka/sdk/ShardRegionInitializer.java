...
import akka.sdk.model.DefaultMessageExtractor;
 ...
 * Initializes based on the configuration provided in the akka.sdk.clusterShards section of yaml file.
 */
@Component
public class ShardRegionInitializer {
     ...
     */
    @Value("${akka.sdk.number.of.shards:10}")
